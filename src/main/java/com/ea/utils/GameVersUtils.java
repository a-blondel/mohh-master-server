...
public class GameVersUtils {
    ...
    public static final String VERS_MOHH2_PSP_HOST = "PSP/MOHGPS081";
    public static final String SLUS_MOHH2_PSP_HOST = "MOHA20000";

    public static final String PSP_MOH_07 = "PSP/MOH07";
    public static final List<String> VERS_MOHH_PSP = List.of(PSP_MOH_07, VERS_MOHH_PSP_HOST, VERS_MOHH2_PSP_HOST); //TODO : remove VERS_MOHH2_PSP_HOST from here
    ...
    public static final List<String> VERS_MOHH2_PSP = List.of(PSP_MOH_07, VERS_MOHH_PSP_HOST, PSP_MOH_08, VERS_MOHH2_PSP_HOST);
    ...
    public static final List<String> VERS_MOHH2_WII = List.of(WII_MOH_08, VERS_MOHH2_PSP_HOST);
    ...
    public static int getTcpPort(String slus) {
        if (SLUS_MOHH_PSP_PAL.contains(slus)) {
            return 11180;
        } else if (SLUS_MOHH_PSP_NTSC.contains(slus) || SLUS_MOHH_PSP_HOST.equals(slus) || SLUS_MOHH2_PSP_HOST.equals(slus)) {
            return 11190;
